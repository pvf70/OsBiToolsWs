...
/**
 * Test Entity Multi Thread processing using web access
 * 
 * @author "Igor Peonte <igor.144@gmail.com>"
 * 
 */
public class MultiEntityUtilsWebIT extends AbstractMultiWebTest {

  @Override
  public Class<BasicEntityUtilsWebIT> getTestClass() {
    return BasicEntityUtilsWebIT.class;
  }
